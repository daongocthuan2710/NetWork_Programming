        ...
        do{
            ...
            switch(option) {
                case 1:
                {
                    ...
                    dictionary.writeFileDictionary(vocab,meaning);
                ...
                case 2:
                {
                    ...
                    String vocab = sc.nextLine();
                    dictionary.removeVocabulary(vocab);
                ...
                case 3:
                {
                    ...
                    System.out.println(dictionary.lookupVocabulary(vocab));
                }
                  break;
                case 4:
                {
                    System.out.println("Your vocabulary list is: ");
                    dictionary.printListVocabulary();
                }
                  break;
                case 5:
                {
                    System.out.println(" The size of vocabulary list is: ");
                    System.out.println(dictionary.printNumberOfVocab());
                }
                  break;
                case 6:
                {
                ...
                case 7:
                {
                    ...
                    System.out.println(dictionary.lookupVocabularyFromMeaning(meaning));
                }
                  break;
                default:
                  // code block
